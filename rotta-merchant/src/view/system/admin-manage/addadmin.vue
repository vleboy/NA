<template>
  <div class="addadmin">
    ...
    <div class="addmanager-form">
      <el-form :model="addadmin" ref="addadmin" label-width="120px" label-position="right">
...
.addadmin .addmanager{width:34rem;margin: 0 auto;margin-top: 4rem}
.addadmin .input{width: 18rem;}
