    ...
    <el-form :model="managerInfo" ref="managerInfo" :rules="rules" label-width="120px" label-position="right">
        <el-form-item label="线路商标识" prop="suffix">
          ...
          <el-form-item label="上级线路商">
            <el-select v-model="managerInfo.parent" placeholder="请选择" clearable class="input">
          ...
          <el-form-item label="生效时间" prop="contractPeriod">
            <el-date-picker v-model="managerInfo.contractPeriod" type="daterange" placeholder="选择生效时间" class="input" label="生效时间" :editable='false' :disabled="managerInfo.isforever"></el-date-picker><el-checkbox v-model="managerInfo.isforever" class="isforever">永久</el-checkbox>
          </el-form-item>
    </el-form>
  </div>
</template>
