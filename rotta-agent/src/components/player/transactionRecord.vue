  ...
  <div class="p-transaction">
    ...
    <div class="-p-header">
      ...
      <el-row>
        ...
        <el-col :span="12">
          ...
          <el-button type="text" @click="openModal(0)">存点</el-button>
          <el-button type="text" @click="openModal(1)">提点</el-button>
        </el-col>
      </el-row>
    </div>
    ...
    <div class="-p-content">
      <el-table  :data="dataList">
        ...
        <el-table-column prop="rate" label="成数" align="center" width="100">
          <template scope="scope">
                <span>
                  {{scope.row.rate}}%
                </span>
        ...
        <el-table-column prop="mix" label="洗码比" align="center" width="100">
          <template scope="scope">
                <span>
                  {{scope.row.mix}}%
                </span>
...
<script type="text/ecmascript-6">
  ...
  export default {
    components:{oneRunningAccount, ArcadeModal, RealLifeModal, OneArmBanditModal, playerRecharge},
    ...
    data () {
      return {
        ...
        isOpenModalBill: false,  // 战绩详细modal
        isOpenModalRunning: false,  // 流水详细
        isOpenModal: false,  // 玩家存提点
        radioInfo: '',
        amountDate: [],
        pickerOptions: {
          shortcuts: [{
...
<style scoped>
  .p-transaction .-p-content{padding: 20px 0 0 0;}
  .p-transaction .-p-h-bottom{margin-bottom: 28px;}
