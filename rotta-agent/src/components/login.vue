<template>
  <div class="login">
    ...
    <div class="login-right">
      <el-form :model="userInfo" :ref="userInfo" label-position="right" label-width="80px">
      ...
      invoke({
        ...
        result => {
          ...
          if (err) {
            ...
            localStorage.setItem('loginParentDisplayName', success.parentDisplayName)
