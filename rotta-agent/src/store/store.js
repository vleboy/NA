...
const actions = {
    ...
    async getallNowplayer(context) {
        if (state.variable.allGameData.nowUserID == '01' || !state.variable.allGameData.nowUserID) {} else {
            // 请求所属玩家基本信息
            var data = {
    ...
    async getnaAllNowplayer(context) {
        if (state.variable.naAllGameData.nowUserID == '01' || !state.variable.naAllGameData.nowUserID) {} else {
            // 请求所属玩家基本信息
            var data = {
    ...
    async getnaVedioNowplayer(context) {
        if (localStorage.loginSuffix == 'Agent') {
            // 代理管理员登录
            if (!state.variable.naVedioGameData.nowUserID) {} else {
                // 请求所属玩家基本信息
                var data = {
    ...
    async getnaLiveNowplayer(context) {
        if (localStorage.loginSuffix == 'Agent') {
            // 代理管理员登录
            if (!state.variable.naLiveGameData.nowUserID) {} else {
                // 请求所属玩家基本信息
                var data = {
    ...
    async getnaArcadeNowplayer(context) {
        if (localStorage.loginSuffix == 'Agent') {
            // 代理管理员登录
            if (!state.variable.naArcadeGameData.nowUserID) {} else {
                // 请求所属玩家基本信息
                var data = {
    ...
    async getnaMallNowplayer(context) {
        if (state.variable.naMallData.nowUserID == '01' || !state.variable.naMallData.nowUserID) {} else {
            // 请求所属玩家基本信息
            var data = {
    ...
    async getttgVedioNowplayer(context) {
        if (localStorage.loginSuffix == 'Agent') {
            // 代理管理员登录
            if (!state.variable.ttgVedioGameData.nowUserID) {} else {
                // 请求所属玩家基本信息
                var data = {
    ...
    async getsaLiveNowplayer(context) {
        if (localStorage.loginSuffix == 'Agent') {
            // 代理管理员登录
            if (!state.variable.saLiveGameData.nowUserID) {} else {
                // 请求所属玩家基本信息
                var data = {
